...
export type StorageHash =
  StorageHashBase<'bb2b9683ad1b5d9f2e570daec6956a1e2ad05cc2e848a8ad29055bd370bb1ef3'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Repository: {
      ...
      readonly localPath: CodecTypes['pg/text@1']['output'];
      readonly visibility: 'PUBLIC' | 'PRIVATE';
      readonly createdById: CodecTypes['pg/int4@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly RepositoryMember: {
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Repository: {
      ...
      readonly localPath: CodecTypes['pg/text@1']['input'];
      readonly visibility: 'PUBLIC' | 'PRIVATE';
        ...
        readonly entries: {
          readonly table: {
            readonly gitAccessToken: {
              ...
              indexes: readonly [
                {
                  readonly name: 'gitAccessToken_userId_idx_a489d58a';
                  readonly prefix: 'gitAccessToken_userId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    ...
                    readonly tableName: 'gitAccessToken';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly repository: {
              ...
              indexes: readonly [
                {
                  readonly name: 'repository_createdById_idx_8bf640ed';
                  readonly prefix: 'repository_createdById_idx';
            ...
            readonly repositoryMember: {
              ...
              primaryKey: { readonly columns: readonly ['repositoryId', 'userId'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'repositoryMember_repositoryId_idx_dce7a8ba';
                  readonly prefix: 'repositoryMember_repositoryId_idx';
                  readonly columns: readonly ['repositoryId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'repositoryMember_userId_idx_a489d58a';
                  readonly prefix: 'repositoryMember_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'repositoryMember';
                    readonly columns: readonly ['repositoryId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            readonly RepositoryMemberRole: {
              readonly kind: 'valueSet';
              readonly values: readonly ['READ', 'WRITE', 'ADMIN'];
            };
            readonly RepositoryVisibility: {
              readonly kind: 'valueSet';
...
> & {
  ...
  readonly roots: {
    ...
    readonly repositoryMember: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'RepositoryMember';
    };
    readonly gitAccessToken: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'GitAccessToken';
    };
      ...
      readonly public: {
        readonly models: {
          ...
          readonly Repository: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly localPath: { readonly column: 'localPath' };
          ...
          readonly RepositoryMember: {
            ...
            readonly storage: {
              readonly table: 'repositoryMember';
              readonly namespaceId: 'public';
              readonly fields: {
          ...
          readonly User: {
            ...
            readonly relations: {
              ...
              readonly repositoryMemberships: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'RepositoryMember';
                };
        ...
        readonly enum: {
          ...
          readonly RepositoryMemberRole: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'WRITE'; readonly value: 'WRITE' },
              { readonly name: 'ADMIN'; readonly value: 'ADMIN' },
            ];
          };
        };
